...
<body>
 <div class="header-area" style="background-image: url('<c:url value="Resources/Images/70.jpg"/>')">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div class="user-menu">
                        <ul>
                            ...
                            <!--  <li><a href=".jsp"><i class="fa fa-user"></i> Login</a></li>-->
                        </ul>
                    </div>
                </div>
                <div class="col-md-4">
  ...
  <div class="mainmenu-area">
    ...
    <input type="search" class="form-control" id="search" placeholder="search for your watches">
